...
## Project Structure
    ...
    ├── vit_instagram_after_30667  # Django project configurations
...
1. Clone this repo and `cd vit_instagram_after_30667`
...
2. Clone this repo and `cd vit_instagram_after_30667`
